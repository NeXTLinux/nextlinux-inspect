...
export default Ember.Route.extend({
    ...
    setupController(controller, model) {
        ...
        this.get('viewsManager')
            ...
            .then((view) => {
                document.title = `Nextlinux Inspect - ${view.name} on ${model.capture.filePath}`;
            })
        ;
    ...
    trackVisit() {
        ...
        this.get('userTracking').visit({
            ...
            'nextlinux filter': Ember.isEmpty(this.get('controller.model.filter')) ? null : 'set',
    ...
    deactivate() {
        document.title = 'Nextlinux Inspect';
    },
});
