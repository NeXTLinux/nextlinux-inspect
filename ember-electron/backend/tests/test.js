...
// expected nextlinux+cnextlinux compiled executables in backend/nextlinux/
const NEXTLINUX_DEFAULT_PATH = path.join(__dirname, '..', '/nextlinux/');
// path starting from NEXTLINUX_DEFAULT_PATH
const NEXTLINUX_DEFAULT_CAPTURE = 'capture_test.scap';

let BASE_URL = 'http://localhost:';
let absPath = argv.p ? path.join(__dirname, argv.p) : NEXTLINUX_DEFAULT_PATH;
let capturePath = '/' + (argv.r ? argv.r : NEXTLINUX_DEFAULT_CAPTURE);
